...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="./assets/UTM-LOGO-FULL.png" alt="" width="227" height="65"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="profilePage.jsp">Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="fineManagement.jsp">Fine Management</a>
        </li>
         <li class="nav-item">
       ...
       <li class="nav-item">
          <a class="nav-link active" href="AdminReport2.jsp">Report</a>
        </li>
               <li class="nav-item">
